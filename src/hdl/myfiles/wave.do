...
add wave -noupdate /max_pooling_top_testbench/dut/pooledValues/control/readAddr
add wave -noupdate /max_pooling_top_testbench/dut/pooledValues/control/writeAddr
add wave -noupdate /max_pooling_top_testbench/dut/pooledValues/control/readAddr1
add wave -noupdate /max_pooling_top_testbench/dut/pooledValues/control/writeAddr1
add wave -noupdate /max_pooling_top_testbench/dut/pooledValues/control/read_next
add wave -noupdate /max_pooling_top_testbench/dut/pooledValues/control/write_next
...
update
WaveRestoreZoom {700 ps} {1586 ps}
